...
<body  >
<!-- Condition 1 Graph -->
<div class="simsubscreen" id="canvas" style="visibility:;"></br>
		...
		<span id="pidata" style="font-size: 20px; position: absolute; left: 300px; top: 30px;">Line Graph for Incipent</span>
...
$handle = @fopen("data/incipient.txt", "r");
if ($handle) {
